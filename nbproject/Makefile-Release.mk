...
${OBJECTDIR}/Server.o: Server.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ilibwebsockets/build/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Server.o Server.cpp

${OBJECTDIR}/TextException.o: TextException.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ilibwebsockets/build/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextException.o TextException.cpp
...
${OBJECTDIR}/bipropellant-hoverboard-api/src/HoverboardAPI.o: bipropellant-hoverboard-api/src/HoverboardAPI.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ilibwebsockets/build/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bipropellant-hoverboard-api/src/HoverboardAPI.o bipropellant-hoverboard-api/src/HoverboardAPI.cpp
...
${OBJECTDIR}/bipropellant-hoverboard-api/src/hbprotocol/ascii_protocol.o: bipropellant-hoverboard-api/src/hbprotocol/ascii_protocol.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilibwebsockets/build/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bipropellant-hoverboard-api/src/hbprotocol/ascii_protocol.o bipropellant-hoverboard-api/src/hbprotocol/ascii_protocol.c
...
${OBJECTDIR}/bipropellant-hoverboard-api/src/hbprotocol/machine_protocol.o: bipropellant-hoverboard-api/src/hbprotocol/machine_protocol.c
	${MKDIR} -p ${OBJECTDIR}/bipropellant-hoverboard-api/src/hbprotocol
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilibwebsockets/build/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bipropellant-hoverboard-api/src/hbprotocol/machine_protocol.o bipropellant-hoverboard-api/src/hbprotocol/machine_protocol.c

${OBJECTDIR}/bipropellant-hoverboard-api/src/hbprotocol/protocol.o: bipropellant-hoverboard-api/src/hbprotocol/protocol.c
	${MKDIR} -p ${OBJECTDIR}/bipropellant-hoverboard-api/src/hbprotocol
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilibwebsockets/build/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bipropellant-hoverboard-api/src/hbprotocol/protocol.o bipropellant-hoverboard-api/src/hbprotocol/protocol.c

${OBJECTDIR}/bipropellant-hoverboard-api/src/protocolFunctions.o: bipropellant-hoverboard-api/src/protocolFunctions.c
	${MKDIR} -p ${OBJECTDIR}/bipropellant-hoverboard-api/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Ilibwebsockets/build/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bipropellant-hoverboard-api/src/protocolFunctions.o bipropellant-hoverboard-api/src/protocolFunctions.c

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Ilibwebsockets/build/include -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
